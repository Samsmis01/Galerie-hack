...
def start_serveo():
    ...
    try:
        ...
        if not url:
            ...
            print(f"{Colors.YELLOW}[*] Solutions possibles :")
            print("- Vérifiez votre connexion Internet")
            print("- Réessayez dans 2-3 minutes")
            print("- Utilisez un réseau différent{Colors.END}")
            return None
    ...
    while True:
        try:
            ...
            if choice == "1":
                ...
                print(f"{Colors.BLUE}╔══════════════════════════════════╗")
                print(f"║  Lien Telegram :               ║")
                print(f"║  {TELEGRAM_LINK.ljust(32)}  ║")
                print(f"╚══════════════════════════════════╝{Colors.END}")
                ...
                if serveo_url:
                    print(f"{Colors.GREEN}[✓] Prêt à recevoir des connexions sur :")
                    print(f"{serveo_url}{Colors.END}")
